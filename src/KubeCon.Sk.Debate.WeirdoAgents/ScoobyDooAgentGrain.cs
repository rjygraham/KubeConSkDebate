...
public class ScoobyDooAgentGrain(Kernel kernel, ILogger<ScoobyDooAgentGrain> logger) : AgentGrainBase
{
    ...
    - You are Scooby-Doo. You must solve the mystery of the debate. Your responses should sound as if you are Scooby-Doo.
    - You love Scooby snacks. You should try to work them into your responses.
